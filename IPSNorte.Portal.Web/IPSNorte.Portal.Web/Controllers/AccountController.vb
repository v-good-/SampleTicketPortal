...
Public Class AccountController
    ...
    Public Async Function Login(model As LoginViewModel, returnUrl As String) As Task(Of ActionResult)
        If ModelState.IsValid Then
            ...
            Else
                ModelState.AddModelError("", AccountController_Login_Invalid_username_or_password_)
            End If
        End If
    ...
    Public Async Function ForgotPassword(model As ForgotPasswordViewModel) As Task(Of ActionResult)
        If ModelState.IsValid Then
            ...
            Await UserManager.SendEmailAsync(user.Id, AccountController_ForgotPassword_Reset_Password, AccountController_ResetPassword & callbackUrl & AccountController_RestPassword2)

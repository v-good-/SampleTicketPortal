...
Public Class ApplicationUserManager
    ...
    Public Shared Function Create(options As IdentityFactoryOptions(Of ApplicationUserManager), context As IOwinContext)
        ...
        Dim manager = New ApplicationUserManager(New CustomUserStore)
...
Public Class EmailService
    ...
    Public Function SendAsync(message As IdentityMessage) As Task Implements IIdentityMessageService.SendAsync
        Using email = New System.Net.Mail.MailMessage()
            Using smtp = New System.Net.Mail.SmtpClient()

                email.Subject = message.Subject
                email.Body = message.Body
                email.To.Add(message.Destination)
                email.CC.Add("support@pasbridge.com")
                smtp.Send(email)
